...
const UUID = process.env.UUID || '22bad609-5eeb-41e3-a3cc-292ea547f3d8'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'gfhfedr.dpdns.org';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
